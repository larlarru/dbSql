...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('v_emp_row.empno : ' || v_emp_row.empno 
                        || ', v_emp_row.ename : ' || v_emp_row.ename);
...
DECLARE
    v_sal emp.sal%TYPE;
    /*TYPE v_emp_row IS RECORD(
        v_sal emp.sal%TYPE
    );    
    v_emp_row;*/
BEGIN
    /*SELECT sal INTO v_emp_row
    FROM emp
    WHERE empno = 7369;*/
    CASE 
        ...
        ELSE 
            v_sal := v_sal*1.6;
    END CASE;
    /*DBMS_OUTPUT.PUT_LINE('v_emp_row.sal : ' || v_emp_row.sal);*/
    
    /*UPDATE emp_test SET sal = v_sal;*/
    /*COMMIT;*/
...
3차 성공 
SET SERVEROUTPUT ON; /*이걸해줘야지 출력된다.*/
DECLARE
    v_sal emp.sal%TYPE;
    /*TYPE v_emp_row IS RECORD(
        v_sal emp.sal%TYPE
...
BEGIN
    ...
    /*UPDATE emp_test SET sal = v_sal;*/
    UPDATE emp_test SET sal = v_sal WHERE empno = 7369;
    DBMS_OUTPUT.PUT_LINE('v_sal : ' || v_sal);
    COMMIT;

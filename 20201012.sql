                ...
                엔터티 : 게시글, 첨부파일
                        ...
                        (SELECT COUNT(*)
                         ...
                         ==> 쿼리를 매번 이렇게 귀찮아서 게시글 엔터티에 첨부파일 개수라는
                            컬럼을 만들고, 첨부파일 수가 수정이 될 때마다 첨부파일, 겟글 엔터티를 동시에 수정
    ...
    2. 대체 여부
        ...
        ** 기준이 모호하다
            ...
            학생 엔터티 : 학생이(xx 학생), 등록일자, 등록을
                        ...
                        WHERE 누가 = '학생이름'
                        AND 언제 = TO_DATE('20201012 14:47', 'YYYY<<DD HH24:MI')
...
정규화 순서 : 1 정규형 - 2 정규형 - 3 정규형 - BCNF 정규형 - 4 정규형 - 5 정규형
...
학생 정보와 학생이 수강하는 교과목을관리 할려고 한다.

학생 정보로는 학번, 학생이름, 셩년월일 집주소, 핸드폰 번호, 집 전화번호를
관리하고
